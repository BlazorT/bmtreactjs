                        ...
                        using (DbDataReader dr = await command.ExecuteReaderAsync())
                        {
                            while (await dr.ReadAsync())
                            {
                                dList.Add(new CampaignNotificationViewModel
                                {
                                    ...
                                    MessageRefId = ""+dr["MessageRefId"],
                                    failureDetails = "" + dr["failureDetails"],
                                    ...
                                    nLastUpdatedAt = Convert.ToDateTime(dr["nLastUpdatedAt"]),
                                    nCreatedAt = Convert.ToDateTime(dr["nCreatedAt"]),
