...
export const getDAPerformancePdf = (reportRows, reportField) => {
  ...
  // Table Headers
  const data = [
    ['Name', 'Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Ave'],

    ['', 'Sun, Feb 04', 'Mon, Feb 05', 'Tue, Feb 06', 'Wed, Feb 07', 'Thu, Feb 08', 'Fri, Feb 09','Sat, Feb 10',''],
    ['POD', '98.51%', '', '98.66%', '', '98.78%', '', '','98.7%'],
    ['CC', '98.51%', '', '', '98.66%', '', '', '98.78%','98.7%'],
    ['DSB', '98.51%', '', '98.66%', '', '98.78%', '', '','98.7%'],
  ];
  ...
  const columnWidths = [20, 24, 24,24,24,24,24,24,20];
