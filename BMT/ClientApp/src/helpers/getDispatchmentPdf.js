...
export const getDispatchmentPdf = (reportRows, reportField) => {
  ...
  // Table Headers
  const data = [
    ['Date', 'DA', 'Assignment', 'Quantity', 'Disp. Time'],

    ['01/16/2024', 'Geraldine, 089029', '','',''],
    ['', '', 'Honda civic, V45008, Sedan', '--', '9: 45: 13'],
    ['', '', 'Left Side Miror, 995008', '9','9: 45: 13'],
    ['', 'Geraldine, 837899', '','',''],
    ['', '', 'Toyota Grandee, Vb9973, Sedan', '--', '9: 45: 13'],
    ['', '', 'headphone, 995008', '15', '9: 45: 13'],
  ];
  ...
  const columnWidths = [35, 45, 60,30,35];
