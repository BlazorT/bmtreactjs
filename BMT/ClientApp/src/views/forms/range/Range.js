...
import { CRow, CCol, CFormLabel, CFormRange } from '@coreui/react'

const Range = ({ minAge, maxAge, onMinAgeChange, onMaxAgeChange }) => {
  return (
    <CRow>
      <CCol xs={12}>
        <h5>Age</h5>
        <div className="d-flex align-items-center flex-wrap gap-4">
          {/* Min Age Slider */}
          <div style={{ flex: 1 }}>
            <CFormLabel htmlFor="minAgeRange">
              Min Age: {minAge}
            </CFormLabel>
            <CFormRange
              id="minAgeRange"
              ...
              max={maxAge}
              value={minAge}
              onChange={(e) => onMinAgeChange(parseInt(e.target.value, 10))}
            />
          </div>

          {/* Max Age Slider */}
          <div style={{ flex: 1 }}>
            <CFormLabel htmlFor="maxAgeRange">
              Max Age: {maxAge}
            </CFormLabel>
            <CFormRange
              id="maxAgeRange"
...
// ✅ Add prop type validation to fix ESLint warning
Range.propTypes = {
